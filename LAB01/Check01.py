...
import numpy as np
from quadraticObjective import quadraticObjective as QO
from bananaValleyObjective import bananaValleyObjective as BO
from PrecCGSolver import PrecCGSolver as PCG
from NewtonDescent import NewtonDescent as ND
...
myObjective = QO(A, b, 1)
x0 = np.array([[0], [0], [0]])
xmin2 = ND(myObjective, x0, 1.0e-6, 1)
xe = np.array([[1], [1], [0.5]])
...
myObjective = BO()
x0 = np.array([[0], [1]])
xmin = ND(myObjective, x0, 1.0e-6, 1)
xe = np.array([[1], [1]])
